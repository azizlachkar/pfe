...
class demandeWO extends StatefulWidget {
  @override
  _demandewo createState() => _demandewo();
}

class _demandewo extends State<demandeWO> {
  Future<Workorders?> submitData(String description, ASSETNUM, location,
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: (() async {
                ...
                Workorders? data = await submitData(description, ASSETNUM,
